...
RELEASE_FIXTURE = (
    ROOT
    / f"tests/fixtures/release/versions/valid-{LATEST_PUBLISHED_VERSION}"
)
WRONG_SIGNERS = ROOT / "tests/fixtures/release/platform-signers/wrong-valid-signers.json"
DIGEST = "sha256:" + "0" * 64
...
class Phase6StaticContracts(unittest.TestCase):
    ...
    def test_unsigned_native_release_runtime_qualification_contract(self) -> None:
        ...
        for required in (
            ...
            "tests/fixtures/native-orchestration/agy-stub.py",
            "HIVE_TEST_HOST_LOG",
            "GITHUB_STEP_SUMMARY",
        ):
