...
| Direct install | npm과 digest-pinned curl·PowerShell·CMD channel | [`0.10.1` release](../releases/0.10.1.md) |
...
- Current public stable version: `0.10.1` (released 2026-09-06)
