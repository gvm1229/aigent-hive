...
- [ ] [BR-001] 브랜치 이름 교정과 현재 문서·기본 규칙의 작업 종류 접두사 정합화
- [ ] [BR-002] 단일 이름 검사·생성 도구·Git 참조 및 게시 훅 구현과 실제 Git 회귀
- [ ] [BR-003] 가벼운 자동 검사와 원격 이름 제한 적용·효과 확인, 기존 기본 브랜치 보호 보존
- [ ] [BR-004] 세 호스트의 공식 훅 계약·기존 구현·실행 가능성 조사와 `0.11.0` 설계 반영
- [ ] [BR-005] 소스 저장소 훅 설치·거부 확인, 문서·시험·근거·상태 정합화
