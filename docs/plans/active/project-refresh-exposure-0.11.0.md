...
- 조사 당시 설치 파일 존재와 Codex 자동 선택 비활성 확인. 미설치와 구분
- 검증 후 기존 [6단계 계획](../../research/example-project-hive-repair-0.11.0.md)에 따라 예시 프로젝트 적용 승인
- `test.3` 공개·Windows 설치 완료. 기준본·예약·Windows 줄끝 병합 오류 보완, 미공개 test.4·5 후보 취소. 수정된 test.6 공개·설치·자연어 갱신 수용 완료, 안정판·main 변경 제외
