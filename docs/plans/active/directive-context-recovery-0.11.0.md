...
- [x] [DCR-001] 승인된 Markdown 구절 선택·내용 지문·경로·출력 상한 검증, 원문 전체 반복·추가 모델 호출 제외
  - state: complete; evidence: repo:tests/results/runs/20260925T091851-1df674af9513.md#sha256:3a4321aac97ba3eb9adda8697f40a95156c2ed6202485d59d3b132be5de91c9b
...
- Windows CLI 훅 계약 24개: 23개 통과, 심볼릭 링크 생성 권한이 없는 1개 제외
