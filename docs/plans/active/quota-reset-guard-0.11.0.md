...
- [x] [RB104-003] `enforce` 경계의 기준 관측 저장과 `hive.usage-reset` 자동 실행 차단
  - state: complete; evidence: repo:tests/results/runs/20260918T164022-1065e14ef4f2.md#sha256:64ac7576d2c87ef31693741eaa88dda42ef35fcbff1cf8c4e140be0d3efc66a0
- [x] [RB104-004] 현재 작업별 초기화 감지 제외·복원과 명시적 재개 계약
  - state: complete; depends: RFH-001; evidence: repo:tests/results/runs/20260920T193729-05f9f88a57f0.md#sha256:6872735b4c33b9fe536710f76d1d1d52089f6c8a81f6f6c1de9c6f2d63eb8964

기존 검토의 한계: Hive에서 진행 중 추론 중단·작업별 15초 감시에 사용할 검증된 Codex API 부재.
2026-09-21 사용자 승인: 15초 감시·진행 중 자동 중단만 [후속 목표](../backlog/periodic-usage-interruption.md)로 이전. 현재 작업 제어와 실행 경계 보호는 0.11.0 유지.
...
- 초기화 감지 제외·복원은 아래 구현으로 검증. 상시 감시·자동 중단은 사용자 승인 후속 범위
...
- 현재 범위의 새 Windows 회귀: 64개 중 61개 통과, Unix 실행 파일·링크 신원 및 POSIX 설정 링크 3개 제외. 제외 운영체제의 실제 동작은 이번 실행에서 미검증
- 현재 완료 판정은 사용자 승인으로 축소한 작업 제어 범위. 후속 상시 감시·실제 추론 중단의 완료 주장 금지
