...
- [x] `REL95-003` Windows x64 실제 host와 M2 MacBook Air 전용 root에서 exact public test artifact의
  clean install·preserving upgrade·validate·bare update path 수용. Windows `test.12 → test.13`, macOS
