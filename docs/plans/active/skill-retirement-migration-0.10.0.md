...
- [ ] [SKM10-002] 게시 stable `0.8.0|0.9.0|0.9.1|0.9.2|0.9.3|0.9.4|0.9.5`가 exact Skill compatibility epoch로 모두 resolve되도록 name·digest·side-effect·capability와 stable-to-epoch mapping 영구 보존
