...
> 적용 범위: 모든 지원 public predecessor에서 `0.10.0` direct upgrade
...
- [ ] [SKM10-002] Historical built-in registry를 모든 지원 public predecessor의 exact Skill name·digest·side-effect·capability로 확대, release surface inventory와 parity
