...
- [x] [KRG10-002] `sources|source_links|links|related_concepts|duplicate_of|contradictions|topics|tags|replacement`의 결정론적 Markdown edge 추출 — `c78c799`; `links|sources|tags|contradictions`의 `EXTRACTED` edge·canonical digest·정렬·중복 제거
