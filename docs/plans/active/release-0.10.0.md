...
- [x] [REL10-003] 번호 공개 `0.10.0-test.N` candidate·publication과 `latest` 불변 확인 — candidate `32633724977`, publication `32634206001`; `test=0.10.0-test.1`, `latest=0.9.5`
- [x] [REL10-004] Windows x64·macOS arm64·Linux musl의 승인 제품 범위 공개 시험 수용 — 다섯 target candidate 성공, 핵심 세 target graph·Graphify 자격 통과, Windows 실제 설치·Codex projection validate 통과
