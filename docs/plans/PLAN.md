...
- [x] public license — `GPL-3.0-only` source와 `Apache-2.0` harness 경계, 전문, package metadata와 render fixture
...
- [GNU — GPLv3 적용 방법](https://www.gnu.org/licenses/gpl-howto.en.html)
