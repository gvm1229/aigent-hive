...
> 현재 milestone: Graphify 격리 조사와 채택 판정
...
- Graphify 조사 하드 게이트 통과 뒤 선택형 지식 graph 도입
...
5. 통과 시 `GPH10-007–016` 제품 구현·upgrade 수용
6. `HWD10-*` 작업 자동 분담 조사
7. `REL10-*` 공개 시험판·안정판 출시
