...
> 공개 Stable: `0.10.3`
> 현재 단계: 실제 갱신의 기준본·예약·Windows 줄끝 병합 보완
> 공개 수용 완료: `0.11.0-test.2`; test.3 공개, 미공개 test.4·5 취소, 다음 시험 `0.11.0-test.6`
...
현재 순서: `PRF-001` → `PRF-004–006` → `PRF-002` → `PRF-003` 실제 예시 적용. 이전 근거는 PDC 계획 보존.
