...
- 기준 branch: `feature/0.10.0@ac178d3`, `origin/feature/0.10.0`과 push 전 local 차이
...
- `adversarial-judge` Skill·clean-context dispatch envelope·`judge-evidence` rename 구현 완료 (`83e9722`, `b60f5e1`, `ac178d3`)
