...
- plan revision: `226`
- 현재 milestone: `HBC95-001`–`HBC95-005`, `AUP95-001`–`AUP95-006`, `RQC95-001`–`RQC95-007`, `NUS-029–030` local gate 완료. 유지보수자 승인 범위: `MAC95-001` macOS qualification, `KBP95-001–003` platform-specific knowledge-bundle guidance and macOS acceptance, `REL95-001–006` public test·protected integration·stable publication. `0.10.0` 후보 작업 제외 유지
