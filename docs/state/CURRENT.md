...
- plan revision: `230`
- 현재 milestone: `HBC95-001`–`HBC95-005`, `AUP95-001`–`AUP95-006`, `RQC95-001`–`RQC95-007`, `NUS-029–030`, `KBP95-001–003`, `REL95-001–002` 완료. `REL95-004`: PortareFolium `0.9.2` Hive-owned subset fixture와 public test artifact 수용 계획. `REL95-003`: Codex plugin marketplace ownership·user projection validate·bare update의 별도 안전 경계. `REL95-005–006` 수용 뒤 순서 유지. `0.10.0` 후보 작업 제외 유지
