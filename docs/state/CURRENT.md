...
- 작업 브랜치: `develop`
- 제품 버전: `0.10.0`
- 공개 시험판: `0.10.0-test.10`, 배포일 2026-08-31
- 제품 수용 소스: `a0cc0a1c0b45a22e70bb93ba92fee744da40c26c`
...
- Agent 소유: 설치 사용자 쉬운 설명 강화·업데이트 안내 자동 축약·`0.10.0-test.11` 재수용
- 유지보수자 권한: `REL10-005–007`의 `0.10.0` 안정판 protected `main` 통합·tag·게시·설치. 현재 요청에서 제외
- 기술 차단: 0건. `test.10`은 변경 전 과거 근거, 현재 제품은 다음 번호 공개 시험 필요
