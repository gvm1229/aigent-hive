...
- 다음 제품 변경: 벡터 최초 설정 답변·고정 범위 안내. 다음 번호 공개 시험 필요
...
- Agent 소유: `VON10-007`, `REL10-001–004` 전체 검사·다음 공개 시험·Windows x64·macOS arm64·Linux musl 공개 수용
- 유지보수자 권한: `REL10-005–007`의 `0.10.0` 안정판 protected `main` 통합·tag·게시·설치. 현재 요청에서 제외
- 로컬 구현: `hive setup feature` 답변·15분 claim·고정 모음 지문·보존형 재설치 완료. Windows 실행 근거만 보유
