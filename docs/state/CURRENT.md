...
- 현재 작업: `DIS9-007`의 사용자 지정 Discord 중단 알림 형식·언어·시험 알림 동등성 구현. 실제 중단 알림과 시험 알림은 같은 renderer·선택 필드·선택 언어 사용, 시험 알림 첫 줄만 변경 안내 고지 추가. `BGR-012–013` source 응답의 내부 용어 억제·사용자 영향 우선 설명과 local
