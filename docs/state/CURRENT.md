...
- plan revision: `236`
- 현재 milestone: `HBC95-001`–`HBC95-005`, `AUP95-001`–`AUP95-006`, `RQC95-001`–`RQC95-007`, `NUS-029–030`, `KBP95-001–003`, `REL95-001–002`, `REL95-004` 완료. `DUP95-001`: Windows 직접 설치 실행 파일 잠금 인계 보강. `DUP95-002`와 `REL95-003`: Windows 11 Home·M2 MacBook Air 전용 시험 루트의 `test.8 → test.9` explicit test-channel package-owner activation·user projection refresh·validate 수용. `REL95-005–006` 수용 뒤 순서 유지. `0.10.0` 후보 작업 제외 유지
