...
summary: "선택형 one-prompt bootstrap의 global/project scope 보존과 한국어 setup product term exact 표기."
...
한국어 global setup: `Skill`·`Wiki` 등 product term exact 유지. Canonical `setup-hive` Skill의 exact
Korean sample·source-to-projection regression 관리.
