...
- public `0.9.5-test.3`: 이후 correction의 수용 증거 제외
- current tree: actual `0.9.2` project copy 수용 실행기와 explicit test update channel 추가
- 다음 수용: `test.4`, 이어서 `test.4 → test.5` user projection
