...
sources:
  ...
  - "repo:docs/research/0.11.0-test9-qualification.md#sha256:7412435fe1acaab75a284d46f98e3b52bfa06ba47765e99a662f1405eca5a061"
...
Test.9 restores approved Markdown within 4,096 bytes, with path guidance and file guards. Every compaction/child start restores without parent deduplication or extra model calls. Changed text is not promoted; invalid settings block guarded edits, with removal available. Public binaries passed 29 contracts per OS. Windows manual compaction reached ten with file checks. Trusted Hive hooks restored after three automatic compactions in one turn. Removal/reapply, including context-disable history, passed public checks. Paired text input saved 1,662 tokens; billing and broad adherence remain unproven. Goal: durable rules with low overhead.
