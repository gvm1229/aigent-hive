...
sources:
  ...
  - "repo:scripts/check-project-base-coverage.py#sha256:64a600db11df5f74b3d9da8f676329dbcab65a722b5399ffc03b7c0df2d1fd22"
...
The archived REL95-004 records public `0.9.5-test.15` matrix acceptance; `test.4` is no longer pending. This historical evidence does not qualify 0.11.0.
