...
summary: "Source agents explain user replies and explanatory writing at a five-year-old comprehension level, preserving technical names, accuracy, and limits."
...
Source replies, guides, blogs, reports, and other explanations assume no technical background:
