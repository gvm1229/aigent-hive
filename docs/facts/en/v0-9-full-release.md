...
`31134306991` and publication `31135040224` from `dc4466d` created `v0.9.0-test.4` with 22 assets.
All six packages have `test=0.9.0-test.4`, `latest=0.8.0`; the annotated prerelease tag is
`v0.9.0-test.4`. Its isolated-install CLI label is `AIgent Hive v0.9.0-test #4 · developer test
build (released 2026-08-07)`.
