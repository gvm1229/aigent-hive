...
sources:
  ...
  - "repo:docs/plans/active/release-0.9.5-stable-publication.md#sha256:a5600ee9b239834774121173ecef757b155d10735f07c13f59da01b72b3b7c83"
...
marker validation defect before user projection. `test.6` packages and tag are public, but GitHub
artifact and Release APIs returned HTTP 503; complete prerelease recovery precedes `test.6 → test.7`.
