...
| `0.10.0` 한국어 언어 core | [en](en/korean-language-core-0-10.md) | [ko](ko/korean-language-core-0-10.md) |
...
| `0.10.0` 벡터 검색 최초 설정 | [en](en/vector-onboarding-0-10.md) | [ko](ko/vector-onboarding-0-10.md) |
| `0.10.1` harness 갱신·사용량 정책 복구 | [en](en/upgrade-usage-v0101.md) | [ko](ko/upgrade-usage-v0101.md) |
...
| Source project-only draft devlog Skill | [en](en/source-project-draft-devlog-skill.md) | [ko](ko/source-project-draft-devlog-skill.md) |
