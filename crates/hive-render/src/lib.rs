...
#[cfg(test)]
use activation::{
    activate_staged_impl, activation_fault_from_value, mutate_exact_projection_claimed,
    replace_capability_file_impl, ActivationFault, ReplacePolicy,
};
