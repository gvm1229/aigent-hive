...
`<role-id>.md`를 staging에서 materialize. Materialize 이후 이 Markdown가
role identity의 runtime 정본이며 seed를 team member로 직접 사용하지 않음.
...
Reconfigure와 update는 assignment, handoff와 사용자 body를 자동 overwrite하지 않음.
